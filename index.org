...
When you work at Google, it scars you. Not so much in the way of harm, but more like a tattoo; something one brandishes; something one is proud of - *pain turned into life experience*.
...
#+BEGIN_QUOTE
/Code is read much more often than it is written, so plan accordingly/ -- [[https://devblogs.microsoft.com/oldnewthing/20070406-00/?p=27343][The Old New Thing]]
#+END_QUOTE

I have been breaking systems for a long time, and written code for an even longer time. I have seen bugs like hidden rocks on an endless stream of runnable prose.
...
+ Code reviews foster /*collaboration and culture*/

I previously talked about how testing makes you go /Faster/. Code reviews make you go /Further/.
